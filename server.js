...
const REF_COLORS = [
  [-30,5,0,0,0,0],[5,10,40,210,255,200],[10,15,0,180,255,210],[15,20,0,255,0,220],
  [20,25,0,200,0,220],[25,30,0,144,0,230],[30,35,255,255,0,240],[35,40,230,192,0,240],
  [40,45,255,144,0,240],[45,50,255,0,0,245],[50,55,214,0,0,245],[55,60,192,0,0,250],
  [60,65,255,0,255,250],[65,70,153,85,201,250],[70,80,255,255,255,255],
];
const VEL_COLORS = [
  [-80,-64,0,130,60,240],[-64,-50,0,166,80,240],[-50,-36,0,200,100,240],
  [-36,-26,0,235,120,240],[-26,-20,100,255,150,230],[-20,-10,160,255,190,220],
  [-10,-1,200,255,220,200],[-1,1,0,0,0,0],[1,10,255,220,200,200],
  [10,20,255,180,150,220],[20,26,255,130,100,230],[26,36,240,80,60,240],
  [36,50,220,30,30,240],[50,64,180,0,0,240],[64,80,130,0,0,240],
];
const SW_COLORS = [
  [0,2,100,100,100,180],[2,4,0,200,255,200],[4,6,0,255,0,220],
  [6,8,255,255,0,230],[8,10,255,150,0,240],[10,15,255,0,0,245],
  [15,20,200,0,200,250],[20,40,255,255,255,255],
];
const RHO_COLORS = [
  [0,0.20,0,0,0,0],[0.20,0.45,100,100,100,180],[0.45,0.55,80,80,80,200],
  [0.55,0.65,0,0,180,210],[0.65,0.75,0,100,255,220],[0.75,0.80,0,200,255,230],
  [0.80,0.85,0,255,200,230],[0.85,0.90,0,255,0,235],[0.90,0.92,180,255,0,240],
  [0.92,0.94,255,255,0,240],[0.94,0.96,255,200,0,245],[0.96,0.97,255,140,0,245],
  [0.97,0.98,255,80,0,250],[0.98,0.99,255,0,0,250],[0.99,1.01,255,0,255,255],
];

function getColor(product, value) {
  const table = product === 'VEL' ? VEL_COLORS : product === 'SW' ? SW_COLORS : product === 'RHO' ? RHO_COLORS : REF_COLORS;
  for (const [min, max, r, g, b, a] of table) {
    if (value >= min && value < max) return [r, g, b, a];
  }
  return [0, 0, 0, 0];
}
